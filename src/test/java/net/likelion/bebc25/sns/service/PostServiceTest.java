...
class PostServiceTest {
    ...
    @WithMockUser(roles = "ADMIN")  // 테스트에서 ADMIN 권한 부여한 가짜 사용자
    void updatePostTest() {
        // given
        Long postId = 1L;
    ...
    @WithUserDetails(value = "user1@example.com", userDetailsServiceBeanName = "customUserDetailsService")   // 이 사용자가 로그인한 것 처럼 해라
    void deletePostTest() {
        // given
        Long postId = 3L;
